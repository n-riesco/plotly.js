...
module.exports = {
    ...
    dictionary: {
        ...
        'Click to enter Colorscale title': 'Clique para introducir el título de la Escala de Color', // plots/plots.js:303
        'Click to enter Component A title': 'Clique para introducir el título del Componente A', // plots/ternary/ternary.js:392
        'Click to enter Component B title': 'Clique para introducir el título del Componente B', // plots/ternary/ternary.js:406
        'Click to enter Component C title': 'Clique para introducir el título del Componente C', // plots/ternary/ternary.js:417
        'Click to enter Plot title': 'Clique para introducir el título de la Gráfica', // plot_api/plot_api.js:579
        'Click to enter X axis title': 'Clique para introducir el título del eje X', // plots/plots.js:301
        'Click to enter Y axis title': 'Clique para introducir el título del eje Y', // plots/plots.js:302
